...
const NAMES_AND_DESCRIPTIONS_FEMALE: Array<[string, string]> = [
  // Tier 0 — L0–8: Fairy-tale characters
  ["Феечка",           "Ты ещё не поднимала ничего тяжелее помады."],
  ["Дюймовочка",       "Помещаешься в цветочный горшок. Пока."],
  ["Мальвина",         "Тренируешься только если причёска в порядке."],
  ["Золушка",          "Жмёшь штангу — тыква уже не нужна."],
  ["Алёнушка",         "Ищешь братца. Нашла гриф."],
  ["Красная Шапочка",  "Корзинку несёшь, но не спешишь."],
  ["Элли",             "Торнадо уже не так страшен."],
  ["Белоснежка",       "Семь гномов смотрят с завистью."],
  ["Принцесса",        "Тебе всё ещё нужна карета."],
  // Tier 1 — L9–17: Curious beginners
  ["Новенькая",        "Ты впервые взяла штангу. Удивилась, что тяжело."],
  ["Снегурочка",       "В зале не тает, но мёрзнет."],
  ["Герда",            "Ищет свой Кай среди гантелей."],
  ["Варвара-краса",    "Коса длинная, результаты — пока нет."],
  ["Любопытная",       "Трогаешь все тренажёры по очереди."],
  ["Непоседа",         "Не можешь стоять на месте — это хорошо."],
  ["Старательница",    "Носишь блокнот в зал. Записываешь всё."],
  ["Ученица",          "Тренер ещё стоит рядом, но уже не так близко."],
  ["Подруга зала",     "Ходишь за компанию. Но уже втянулась."],
  // Tier 2 — L18–26: Getting serious
  ["Пеппи",            "Конь на плечах? Легко."],
  ["Мэри Поппинс",     "С ложкой сахара и без паузы."],
  ["Зажигалка",        "Заряжаешь весь зал своей энергией."],
  ["Трудяга",          "Пропустить тренировку — не твоё."],
  ["Регулярная",       "Тебя уже знают на рецепшене."],
  ["Активистка",       "Берёшь карточку на месяц вперёд."],
  ["Цепкая",           "Гриф уже не выскальзывает."],
  ["Резкая",           "Взрывная сила растёт."],
  ["Заряженная",       "После тренировки ещё болтаешь час."],
  // Tier 3 — L27–35: Athletic heroines
  ["Спортивная",       "Форма заметна. Чуть-чуть."],
  ["Ловкая",           "Координация уже не подводит."],
  ["Быстрая",          "Успеваешь всё: и жим, и беговую дорожку."],
  ["Мерида",           "Лук не нужен — штанга точнее."],
  ["Мулан",            "Нормативы армии пройдены."],
  ["Атаманша",         "В зале тебя слушаются."],
  ["Смелая",           "Подходишь к штанге без страха."],
  ["Дисциплинированная", "День ног — святое."],
  ["Разрядница",       "Результаты уже говорят сами за себя."],
  // Tier 4 — L36–44: Action heroines
  ["Боевая",           "На помост выходишь без дрожи."],
  ["Лучница",          "Прицел точный, результат — тоже."],
  ["Кэтнисс",          "Голодные игры на штанге выиграны."],
  ["Амазонка",         "Лошадь не нужна — и так быстро."],
  ["Каратистка",       "Удар отточен. И жим тоже."],
  ["Подтянутая",       "Смотришь в зеркало с одобрением."],
  ["Боец",             "В зале — как у себя дома."],
  ["Тренированная",    "Новички смотрят с уважением."],
  ["Железная леди",    "Первые шаги к легенде сделаны."],
  // Tier 5 — L45–53: Warrior women
  ["Рей",              "Световой меч не нужен — штанга надёжнее."],
  ["Чёрная Вдова",     "Тихо. Точно. Мощно."],
  ["Воительница",      "Каждая тренировка — битва с собой."],
  ["Охотница",         "Цель поставлена. Промахов нет."],
  ["Командирша",       "За тобой идут в зал."],
  ["Силовая атлет",    "Готова к соревнованиям."],
  ["Гром",             "Вход в зал — как раскат грома."],
  ["Крепкая",          "Двигаешь то, что другие обходят."],
  ["Непробиваемая",    "Тебя ничем не сломить."],
  // Tier 6 — L54–62: Russian bogatyr heroines + international warriors
  ["Поляница",         "Русская богатырша. Слово держит."],
  ["Богатырша",        "Три богатыря кивают с уважением."],
  ["Атланта",          "Золотые яблоки её не остановили."],
  ["Несломимая",       "Не та, с кем стоит спорить в зале."],
  ["Сталь",            "Под майкой — броня."],
  ["Жанна д'Арк",      "Ведёшь за собой без слов."],
  ["Зена",             "Корону носит на плечах, не на голове."],
  ["Гроза",            "Тебе уступают место в стойке."],
  ["Мастерица",        "Техника безупречна."],
  // Tier 7 — L63–71: Champion-tier
  ["Валькирия",        "Забирает лучших. В зале — ты."],
  ["Гром-баба",        "Земля дрожит."],
  ["Чудо-Женщина",     "Ты — Диана. Точка."],
  ["Профессионалка",   "Молодёжь смотрит как на легенду."],
  ["Сильнейшая",       "В твоём зале нет тебе равных."],
  ["Чемпионка",        "Все рекорды — твои."],
  ["Атлет высшего класса", "Тебя зовут на турниры."],
  ["Эксперт железа",   "Тренеры консультируются у тебя."],
  ["Несокрушимая",     "Твоя воля — как металл."],
  // Tier 8 — L72–80: Legendary
  ["Богиня силы",      "Зал — твой храм."],
  ["Бессмертная",      "Усталость незнакома."],
  ["Великанша",        "Ты — сила природы."],
  ["Полубогиня",       "Земля дрожит, когда ставишь штангу."],
  ["Олимпийка",        "Достойна античных мифов."],
  ["Артемида",         "Охотится за рекордами. Всегда попадает."],
  ["Геркулесша",       "12 подвигов — твоя разминка."],
  ["Титанша",          "Способна сдвинуть мир."],
  ["Легенда",          "Твоё имя будут помнить века."],
];
